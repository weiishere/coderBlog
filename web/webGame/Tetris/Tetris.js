...
var DiaManager = (function () {
    this.rows = new Array(setting.lineCount);
    ...
    move: function (_dias, _dias2, order) {
        ...
        customMothed = function () {
            ...
            for (var i = 0; i < 4; i++) {
                ...
                if (_dias[i].con_x == _dias2[i].con_x && _dias[i].con_y == _dias2[i].con_y && this.isStop == true) {
                    this.isStop = true;
                } else {
                    this.isStop = false;
                }
...
var gameManager = {
    begin: function (fps) {
        this.setTimer();
        window.setInterval(function () { draw.map(); }, 1000 / fps);
    },
    setTimer: function () {
        this.createDia();
...
test = function () { moveManager.rotate(); }