...
(function ($) {
    ...
    var imgData = new Array(
        { name: "back", path: "sky_1.gif" },
        { name: "back2", path: "sky_2.jpg" },
        { name: "man", path: "yellowPerson.png" },
        { name: "floor_1", path: "floor_1.png" },
        { name: "floor_2", path: "floor_2.png" },
        { name: "floor_3", path: "floor_5.png" },
        { name: "floor_4", path: "floor_6.png" },
        { name: "floor_5", path: "floor_3.png" });
    $(function () {
        ...
        function gameInit(result) {
            ...
            title.y = 100; title.size = 26; title.color = "#ffffff"; title.text = "是男人就下一百层";
        ...
        function onframe() {
            ...
            if (man.y >= LGlobal.height) {
                alert("Game over，小黄人挂啦，得分：" + downDistance);
                backLayer.die();
                backLayer.removeAllChild();
                main();
                return;
        ...
        function Background(bgImgName) {
            ...
            self.run = function () {
                ...
                //    self.bitmap1 = self.bitmap2.y;
                //    self.bitmap2 = self.bitmap1.y + self.bitmap1.getHeight();
                //    self.bitmap3 = self.bitmap1.y + self.bitmap1.getHeight() * 2;
                //}
            }
